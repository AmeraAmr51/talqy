...
<div class="container">
    <div class="d-flex align-items-center justify-content-between p-5" >
        <h2 class="h1 mx-3">جميع الاختبارات</h2>
                    ...
                    <table id="kt_datatable_horizontal_scroll" class="table table-striped table-row-bordered gy-5 gs-7" >
                        <thead>
                            <tr class="fw-semibold fs-6 text-gray-800"  >
                                <th class="min-w-200px" style="text-align: right;">اسم الاختبار</th>
                                <th class="min-w-150px" style="text-align: right;"> مده الاختبار</th>
                        ...
                        <tbody>
                            ...
                            @foreach($exams as $m)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('exam.edit',$m->id)}}"><i role="button" class="fa-solid fa-pen-to-square fs-3 mx-3"></i></a>
                                                            <a href="{{route('exam.delete',$m->id)}}"><i role="button" class="fa-solid fa-trash fs-3 want_delete_btn"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
