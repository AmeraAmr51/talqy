            ...
            <div class="mt-5">
                <div class="container">
                    ...
                    <div class="row gy-4 mt-5 text-center">
                        ...
                        <div class="col-md-3">
                            <div role="button" class="box-of-book rounded p-5" style="box-shadow: 0px 0px 5px 0px #aaa;">
                                <div style="width: 80px;height: 80px;" class="rounded-circle border-black mx-auto d-flex align-items-center justify-content-center">
                                    <span><input hidden name="book_id" value="{{$book->id}}">{{$book->id}}</span>
                                </div>
                        ...
                        {{-- <div class="col-md-3">
                            <div role="button" class="box-of-book rounded p-5" style="box-shadow: 0px 0px 5px 0px #aaa;">
                                ...
                                <h4 class="h2 mt-3">اسم الكتاب</h4>
                            </div>
                        </div> --}}
                        {{-- <div class="col-md-3">
                            <div role="button" class="box-of-book rounded p-5" style="box-shadow: 0px 0px 5px 0px #aaa;">
                    ...
                    <div class="mt-5 d-flex align-items-center justify-content-end ">
                        ...
                        <a class="solid-black-btn btn mx-2" href="{{route('videos.addnewVideosBaB')}}">التالي</a>
                    </div>
                </div>
            </div>
            <!--End choose Subject-->
