                    ...
                    <form class="pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form"  >
                                    ...
                                    <div class="my-4">
                                        ...
                                        <div id="days-container" style="margin-top:20px;">
                                            ...
                                            <table class="table" style="width:50%; border:1px solid #e4e6ef; border-radius: 10px !important; ">
                                                ...
                                                <tbody>
                                                  <tr class="day-item" v-for="(day, index) in courseDays" :key="index">
                                                    <th >@{{ day.day }}</th>
                                                    <td>@{{ day.from }}</td>
                                                    <td>@{{ day.to }}</td>
                                    ...
                                    <div class="row gy-5">
                                        <div class="col-md-6">
                                            <div class="border rounded d-flex align-items-center justify-content-between ">
                                                ...
                                                <p class="m-0 px-5">
                                                    <a href="{{route('course.show')}}"> <i role="button" class="fa-solid fa-trash-can fs-3 want_delete_btn"></i></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex flex-stack pt-10">
                            ...
                            <div>
                                ...
                                <a type="button" class="regular-black-btn btn mx-2" href="{{route('course.show')}}" >حفظ كمسودة
