                    ...
                    <form class="pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form"  >
                                ...
                                <div class="mt-5">
                                    <div class="container">
                                        <div class="text-center" style="margin-bottom:60px;">
									        ...
									        <p class="m-0 fs-3 text-gray-500">اختر الكتاب لأدخال الملف عليه</p>
                                        </div>
                                ...
                                <div class="mt-5">
                                    <div class="container">
                                        <div class="text-center">
                                            ...
                                            <p class="m-0 fs-3 text-gray-500">اختر الباب لأدخال الملف عليه</p>
                                        </div>
                                        <div class="row gy-5 mt-5 text-center">
                                            <div class="col-md-3 p-2" v-for="i in part_data" :key="i.id">
                                                    ...
                                                    <label class="btn btn-outline btn-active-light-primary" :class="{'selected': {{$material-> part_id}} == i.id}" style="width:100%; box-shadow: 0px 0px 5px 0px #aaa !important; border-radius:10px;" :for="'part_' + i.id">
                                                      <!--begin::Info-->
                                                      <div style="width: 80px; height: 80px;" :class="{'border-black': {{$material-> part_id}} != i.id, 'border-white': {{$material-> part_id}} == i.id}" class="rounded-circle  mx-auto d-flex align-items-center justify-content-center">
                                                        <span>@{{ i.id }} </span>
                                                      </div>
                                                      <div>
                                                        <h4 class="h2 mt-3" style="font-size: 15px;" :style="{ color: {{$material-> part_id}} == i.id ? 'white' : 'black' }">@{{i.title}}</h4>
                                                      </div>
                                                      <!--end::Info-->
                                                    </label>
                                            </div>
                                ...
                                <div class="mt-5">
                                    <div class="container">
                                        <div class="text-center">
                                            ...
                                            <p class="m-0 fs-3 text-gray-500">اختر الفصل لأدخال الملف عليه</p>
                                        </div>
                                        <div class="row gy-5 mt-5 text-center">
                                            <div class="col-md-3 p-2" v-for="i in chapter_data" :key="i.id">
                                                    ...
                                                    <label class="btn btn-outline btn-active-light-primary" :class="{'selected': {{$material-> chapter_id}} == i.id}" style="width:100%; box-shadow: 0px 0px 5px 0px #aaa !important; border-radius:10px;" :for="'chapter_' + i.id">
                                                      <!--begin::Info-->
                                                      <div style="width: 80px; height: 80px;" :class="{'border-black': {{$material-> chapter_id}} != i.id, 'border-white': {{$material-> chapter_id}} == i.id}" class="rounded-circle  mx-auto d-flex align-items-center justify-content-center">
                                                        <span>@{{ i.id }} </span>
                                                      </div>
                                                      <div>
                                                        <h4 class="h2 mt-3" style="font-size: 15px;" :style="{ color: {{$material-> chapter_id}} == i.id ? 'white' : 'black' }">@{{ i.title }}</h4>
                                                      </div>
                                                      <!--end::Info-->
                                                    </label>
                                            </div>
						...
						<div class="mt-5">
							<div class="container">
								<div class="text-center">
                                    ...
                                    <p class="m-0 fs-3 text-gray-500">اختر الدرس لإدخال الملف عليه</p>
                                </div>
							</div>
						</div>
						<!--End choose Subject-->
                        ...
                        <div class="container">
                            <div class="text-center" style="margin-bottom:90px;">
                                <h3 class="h1"> الملفات</h3>
                                <p class="m-0 fs-3 text-gray-500"></p>
                            </div>
                            <div class="row gy-3 align-items-center" style="margin-bottom:90px;">
                                <div class="col-md-4">
                                    <div>
                                        <p class="m-0 fs-5 fw-bold">اسم الملف</p>
                                        <input type="text" placeholder="اسم الملف" name="title" id="title"  v-model="title"  class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div>
                                        <div>
                                            <p class="m-0 fs-5 fw-bold">تحميل ملف</p>
                                            <div class="position-relative w-100 border rounded d-flex align-items-center justify-content-between " style="height: 45px;">
                                                <p class="m-0 px-3 text-gray-two" style="flex-grow: 1;">أضف الملف</p>
                                                <button class="solid-black-btn btn">تصفح</button>
                                                <input type="file" name="file" @change="handleFileChange"  placeholder="اضف االملف" role ="button" style="opacity: 0;" class="position-absolute start-0 top-0 end-0 top-0 bottom-0"/>
                                            </div>
                                            <div style =" margin-top:10px; ">
                                            <a  class="rounded w-150px" target="_blank" href="{{asset('materials/files/' . $material->file)}}">{{$material->file}}</a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div>
                                        <div>
                                            <p class="m-0 fs-5 fw-bold">تحميل صورة الغلاف</p>
                                            <div class="position-relative w-100 border rounded d-flex align-items-center justify-content-between " style="height: 45px;">
                                                <p class="m-0 px-3 text-gray-two" style="flex-grow: 1;"> أضف الغلاف</p>
                                                <button class="solid-black-btn btn">تصفح</button>
                                                <input type="file" name="cover" @change="handleCoverChange" placeholder="اضف الغلاف" role="button" style="opacity: 0;" class="position-absolute start-0 top-0 end-0 top-0 bottom-0"/>
                                            </div>
                                            <div style =" margin-top:10px; ">
                                            <a  class="rounded w-150px" target="_blank" href="{{asset('materials/imgs/' . $material->cover)}}">{{$material->cover}}</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="d-flex align-items-center p-5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="m-0 mx-3 text-gray-500" style="font-size: 14px;">
                                                            ...
                                                            <span class="mx-3">{{$material->created_at}}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <p class="m-0 px-5">
                                                    <a href="{{route('file.delete',$material->id)}}"> <i role="button" class="fa-solid fa-trash-can fs-3 want_delete_btn"></i></a>
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="d-flex flex-stack pt-10">
                            ...
                            <div>
                                ...
                                <a type="button" class="regular-black-btn btn mx-2" href="{{route('file.show')}}" >حفظ كمسودة </a>
...
mounted:function() {
    ...
    $.ajax({
      ...
      contentType: false,
      data: formData,
      url: '{{ route('file.update', ['id' => $material->id]) }}',
      success: function(response) {
                  ...
                  new swal({
                    ...
                    window.location.href = "{{ route('file.show') }}";
                  });
                },
