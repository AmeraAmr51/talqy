                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <div class="position-relative w-100 border rounded d-flex align-items-center justify-content-between " style="height: 45px;">
                                                <p class="m-0 px-3 text-gray-two" style="flex-grow: 1;">لم يتم احتيار اي ملف</p>
                                                <button class="solid-black-btn btn">تصفح</button>
                                                <input type="file" name="file" @change="handleFileChange"  role="button" style="opacity: 0;" class="position-absolute start-0 top-0 end-0 top-0 bottom-0"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <div class="position-relative w-100 border rounded d-flex align-items-center justify-content-between " style="height: 45px;">
                                                <p class="m-0 px-3 text-gray-two" style="flex-grow: 1;">لم يتم احتيار اي ملف</p>
                                                <button class="solid-black-btn btn">تصفح</button>
                                                <input type="file" name="cover" @change="handleCoverChange" role="button" style="opacity: 0;" class="position-absolute start-0 top-0 end-0 top-0 bottom-0"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row gy-5">
                                        <div class="col-md-6">
                                            <div class="border rounded d-flex align-items-center justify-content-between ">
                                                ...
                                                <p class="m-0 px-5">
                                                    <a href="{{route('file.show')}}"> <i role="button" class="fa-solid fa-trash-can fs-3 want_delete_btn"></i></a>
                                                </p>
                                            </div>
                                        </div>
