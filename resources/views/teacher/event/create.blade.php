                    ...
                    <form class="pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form"  >
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row gy-5 mt-5 text-center">
                                            ...
                                            <div class="col-md-3 p-2" v-for="i in part_data" :key="i.id">
                                                  ...
                                                  {{-- <select class="form-control " id="exampleSelectd3" v-on:change="getChapters"  v-model="part_id"  name="part_id" disabled>
                                                    <option disabled value="">Choose one </option>
                                                    <option v-for="i in part_data" :value="i.id">@{{i.title}}</option>
                                                </select> --}}
                                ...
                                <div class="container">
                                    ...
                                    <div>
                                        <div class="my-4">
                                            ...
                                            <textarea  name="description" id="description"  v-model="description" class="tox-target kt_docs_tinymce_hidden" style="height: 200px;"></textarea>
                                        </div>
                                        <div>
                                            <h4 class="m-0 my-4">ماذا ستتعلم ؟</h4>
                                            <textarea  name="what_you_learn" id="what_you_learn"  v-model="what_you_learn" class="tox-target kt_docs_tinymce_hidden"></textarea>
                                        </div>
                                        <div>
                                            <h4 class="m-0 my-4">متطلبات</h4>
                                            <textarea  name="requirments" id="requirments"  v-model="requirments" class="tox-target kt_docs_tinymce_hidden"></textarea>
                                        </div>
                                        <div>
                                            <h4 class="m-0 my-4">لمن هذه الدورة ؟</h4>
                                            <textarea  name="who_package_for" id="who_package_for"  v-model="who_package_for" class="tox-target kt_docs_tinymce_hidden"></textarea>
                                        </div>
                                        <div>
                                            <h4 class="m-0 my-4">رسالة التسجيل</h4>
                                            <textarea  name="enroll_message" id="enroll_message"  v-model="enroll_message" class="tox-target kt_docs_tinymce_hidden"></textarea>
                                        </div>
                                    </div>
                                    <div class="my-4">
                                        <h4>رابط whatapp</h4>
                                    ...
                                    <div class="my-4">
                                        ...
                                        <div id="days-container" style="margin-top:20px;">
                                            ...
                                            <table class="table" style="width:50%; border:1px solid #e4e6ef; border-radius: 10px !important; ">
                                                ...
                                                <tbody>
                                                  <tr class="day-item" v-for="(day, index) in eventDays" :key="index">
                                                    <th >@{{ day.day }}</th>
                                                    <td>@{{ day.from }}</td>
                                                    <td>@{{ day.to }}</td>
                                                    <td class="remove-day-btn" @click="removeDay(index)"><i class="fa-solid fa-trash fs-1"></i></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                        </div>
                                    ...
                                    <div class="row gy-5">
                                        <div class="col-md-6">
                                            <div class="border rounded d-flex align-items-center justify-content-between ">
                                                ...
                                                <p class="m-0 px-5">
                                                    <a href="{{route('event.show')}}"> <i role="button" class="fa-solid fa-trash-can fs-3 want_delete_btn"></i></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex flex-stack pt-10">
                            ...
                            <div>
                                ...
                                <a type="button" class="regular-black-btn btn mx-2" href="{{route('event.show')}}" >حفظ كمسودة
  ...
  watch: {
    ...
    addDay: function () {
        ...
        removeDay: function (index) {
            // Remove the day at the specified index from the array
