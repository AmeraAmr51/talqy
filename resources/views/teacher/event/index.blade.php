...
<div class="container">
    <div class="d-flex align-items-center justify-content-between p-5" >
        <h2 class="h1 mx-3">جميع دورات البث المباشر</h2>
                ...
                <tbody>
                                        ...
                                        @foreach($events as $event)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('event.edit',$event->id)}}"><i role="button" class="fa-solid fa-pen-to-square fs-3 mx-3"></i></a>
                                                    <a href="{{route('event.delete',$event->id)}}"><i role="button" class="fa-solid fa-trash fs-3 want_delete_btn"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
