            ...
            <div class="auth-form">
                <div class="w-75 mx-auto">
                    ...
                    <div style="margin-top:150px">
                        <h2  style="font-size: 35px;;"> كلمة السر</h2>
                        <p class="m-0 fs-3 my-3 text-gray-custom">أدخل البريد الألكتروني أو رقم الهاتف الذي قمت بادخاله من قبل</p>
                    </div>
...
@endif
                    <form class="mt-10" method="POST" action="{{ route('admin.password.email') }}">

                            @csrf
                        <div>
                            <h3>البريد الإلكتروني أو رقم الهاتف</h3>
                            <input class="form-control " name="email" id="email" type="email" placeholder="البريد الألكتروني أو رقم الهاتف"/>
                        </div>
                        <button type="submit" class="btn solid-black-btn d-block mx-auto w-100 fs-3 mt-6">ارسال</button>
