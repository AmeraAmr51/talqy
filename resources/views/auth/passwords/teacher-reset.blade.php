            ...
            <div class="auth-form">
                <div class="w-75 mx-auto">
                    ...
                    <div style="margin-top:90px" >
                        <h2  style="font-size: 35px;;">قم بتعيين كلمة مرور جديدة</h2>
                        <p class="m-0 fs-3 my-3 text-gray-custom" >أدخل كلمة المرور الجديدة أدناه وتحقق من التلميح أثناء تعيينه.</p>
                    </div>
                ...
                @endif
                    <form class="mt-10 signUp_form" method="post" action="{{ route('admin.password.reset') }}">
                        @csrf
                        ...
                        <div class="mt-10" >
                            ...
                            <div class="position-relative">
                                <input style="direction: rtl !important" class="form-control input_password" type="password" name="password" id="password" placeholder="كلمة السر"/>
                        ...
                        <div class="mt-10">
                            ...
                            <div class="position-relative">
                                <input style="direction: rtl !important" class="form-control input_password" type="password" name="password_confirmation" id="password_confirmation" placeholder="تأكيد كلمة السر"/>
                                <span class="position-absolute" style="top: 13px;left: 8px;">
                                    <i class="fa-regular fa-eye-slash text-gray-custom fs-4 input_eye" role="button"></i>
                                </span>
                            </div>
                        </div>
                        <button class="btn solid-black-btn d-block mx-auto w-100 fs-3 mt-6 sending_btn">ارسال</button>
                    </form>
                </div>
            </div>
...
<script src="{{asset('admin/js/dashboard/setNewPassword.js')}}"></script>
</html>
