        ...
        <section class="d-flex" style="min-height: 100vh;">
            <div class="auth-form">
                <div class="w-75 mx-auto">
                    ...
                    @endif
                    <form class="mt-10" action="{{ route('teacher.login') }}" method="POST">
                        {{ csrf_field() }}
                        <div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            ...
                            <a href="{{route('teacher.password.forgot')}}" class="m-0 fw-bolder fs-5 text-black">هل نسيت كلمة المرور ؟</a>
                        </div>
                        ...
                        <div class="d-flex justify-content-center fw-bold mt-10 fs-4">
                            <span class="text-gray-custom">ليس لديك حساب ؟</span>
                            <span class="mx-3 underline" role="button"><a href="{{route('teacher.registerform')}}" class="text-black">انشئ حساب</a></span>
                        </div>
                    </form>
                </div>
            </div>
