...
<html direction="rtl" dir="rtl" style="direction: rtl">
	...
	<body id="kt_app_body" data-kt-app-layout="" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer d-flex align-items-center symbol symbol-35px" data-kt-menu-trigger="{default: 'click'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<p class="m-0 mx-2 fw-bold">{{Auth::guard('teacher')->user()->name}} </p>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										<div class="p-5">
											...
											<div class="d-flex align-items-center px-3  py-3  navbar-user" role="button">
												...
												<p class="m-0 fw-bold fs-4 mx-3"><a href="{{route('teacher.logout')}}">تسجيل الخروج </a></p>
											</div>
										</div>
										<!--begin::Menu item-->
									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('videos.create')}}">
														<span class="menu-bullet">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('exam.show')}}">
														<span class="menu-bullet">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('exam.add')}}">
														<span class="menu-bullet">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('file.show')}}">
														<span class="menu-bullet">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('file.add')}}">
														<span class="menu-bullet">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('course.show')}}">
														<span class="menu-bullet">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('course.add')}}">
														<span class="menu-bullet">
															<i class="fa-regular fa-square-plus fs-5"></i>
														</span>
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('event.show')}}">
														<span class="menu-bullet">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="{{route('event.add')}}">
														<span class="menu-bullet">
															<i class="fa-regular fa-square-plus fs-5"></i>
														</span>
		...
		<script src="{{asset('admin/js/dashboard/uploadLive.js')}}"></script>
