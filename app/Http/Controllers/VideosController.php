...
class VideosController extends Controller
{
    ...
    public function index()
    {
        ...
        $levels=Level::all();
        $videos=Video::with('lesson')->with('status')->get();
        return view('teacher.videos.index',compact('subjects','levels','videos'));
    }
    ...
    public function create()
    {
        ...
        $lessons=Lesson::get();
        return view("teacher.videos.addVideo",compact('books','chapters','parts','lessons'));
    }
