    ...
    methods: {
        ...
        markExam: function(){
            ...
            if(app.overallScore >= 75){
                this.ScoreMsg = '<h4 style="font-weight:bold">:'+quizHistoryAttr.translation.overallPerformance+'<b style="color:green;" class="mx-2">'+quizHistoryAttr.translation.passed+'</b></h4>You have passed the exam, congratulations.';
            }else{
